        ...
        <form action="{{ route('redaksi.update', $redaksi->news_id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                    value="{{ old('title', $redaksi->title) }}" required>
                @error('title')
            ...
            @if ($redaksi->image)
                <div class="mb-3">
                    ...
                    <img src="{{ asset('storage/public/posts/' . $redaksi->image) }}" alt=""
            ...
            <div class="mb-3">
                ...
                <textarea name="content" rows="8" class="form-control @error('content') is-invalid @enderror" required>{{ old('content', $redaksi->content) }}</textarea>
                @error('content')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
